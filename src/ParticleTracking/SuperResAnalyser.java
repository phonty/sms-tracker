...
//            stacks = imp.getImageStack();
    ...
    ImagePlus buildOutput(Analyse_ analyser) {
        ...
        for (int i = 0; i < stacks[0].getSize(); i++) {
            ...
            ParticleArray curves = analyser.findParticles(coFactor, false, i, i, UserVariables.getCurveFitTol(), stacks[0], stacks[1], true, SIG_EST_RED, SIG_EST_GREEN, UserVariables.isColocal());
